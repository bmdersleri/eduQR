 ...
 *
 * Predates NFR-78 and keeps its name so that the catch sites in
 * `AnswerController` and `templates/student/play.php` — which name the class,
 * not a code — go on working. It is a `ConflictException` so that the
