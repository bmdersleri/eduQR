...
<head>
    ...
    <title><?= function_exists('t') ? htmlspecialchars(t('error.not_found'), ENT_QUOTES, 'UTF-8') : 'eduQR' ?> — eduQR</title>
...
<main class="eduqr-error-page">
    <section class="eduqr-surface eduqr-error-card">
        ...
        <h1 class="h3 mb-3"><?= function_exists('t') ? htmlspecialchars(t('error.not_found'), ENT_QUOTES, 'UTF-8') : 'eduQR' ?></h1>
        <p class="mb-4"><?= function_exists('t') ? htmlspecialchars(t('error.not_found'), ENT_QUOTES, 'UTF-8') : 'eduQR' ?></p>
